...
public class pythonIdentifiersLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"Letter", "Digit", "OpenParenthesis", "ClosingParenthesis", "EqualSign", 
	...
	public pythonIdentifiersLexer(CharStream input) {
		super(input);
